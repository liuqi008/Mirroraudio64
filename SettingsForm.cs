...
namespace MirrorAudio
{
    sealed class SettingsForm : Form
    {
        ...
        public SettingsForm(AppSettings cur, Func<StatusSnapshot> statusProvider)
        {
            ...
            Controls.Add(split);
            EventHandler do50=(s,e)=>{ if(split.Width>0) split.SplitterDistance=split.Width/2; };
            ...
            tblS.ColumnStyles.Add(new ColumnStyle(SizeType.Percent,32)); tblS.ColumnStyles.Add(new ColumnStyle(SizeType.Percent,68));
            ...
            tInput.ColumnStyles.Add(new ColumnStyle(SizeType.Percent,34)); tInput.ColumnStyles.Add(new ColumnStyle(SizeType.Percent,66));
            cmbInput.DropDownStyle=ComboBoxStyle.DropDownList;
            AddRow(tInput,"输入设备",cmbInput);
            gInput.Controls.Add(tInput); right.Controls.Add(gInput);
            ...
            cmbMain.DropDownStyle=ComboBoxStyle.DropDownList; cmbShareMain.DropDownStyle=ComboBoxStyle.DropDownList; cmbSyncMain.DropDownStyle=ComboBoxStyle.DropDownList;
            ...
            cmbAux.DropDownStyle=ComboBoxStyle.DropDownList; cmbShareAux.DropDownStyle=ComboBoxStyle.DropDownList; cmbSyncAux.DropDownStyle=ComboBoxStyle.DropDownList;
